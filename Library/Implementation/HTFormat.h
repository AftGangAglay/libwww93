 ...
 */
extern void
HTSetPresentation PARAMS((CONST char* representation, CONST char* command,
								 float quality,
								 float secs,
								 float secs_per_byte
						 ));
...
extern HTStream* HTStreamStack PARAMS(
		(HTFormat format_in, HTFormat format_out, HTStream * stream_out,
 ...
 */
extern float HTStackValue PARAMS((HTFormat format_in, HTFormat rep_out,
										 float initial_value,
										 long int length));
